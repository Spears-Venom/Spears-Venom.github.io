...
function totalPopulationDotHisto() {
		...
		legendTitle = "Urban population - 2011";
		dotTitle = "Growth in urban population between 2001 and 2011";
		//Set the y-axis scale
		dotScaleX.domain(d3.extent(data, function(d) {return d.pop_growth/10;}));	
		createDotHisto();
...
function totalLandDotHisto() {
		...
		legendTitle = "Urban land - 2011";
		dotTitle = "Growth in urban land between 2001 and 2011";
		//Set the y-axis scale
		dotScaleX
			.domain([d3.min(data, function(d) {return d.land_growth/10;}), maxNum])
			.clamp(true);	
		createDotHisto();
...
function totalDensityDotHisto() {
		...
		legendTitle = "Population density - 2011";
		dotTitle = "Growth in avg. urban population density between 2001 and 2011";
		//Set the y-axis scale
		dotScaleX.domain(d3.extent(data, function(d) {return d.density_growth/10;}));	
		createDotHisto();
...
function createDotHisto() {
	...
	cities2010.selectAll(".city_2010")
		...
		.style("fill", function(d) { return color(eval("d." + rVar + "_2011")); })
		.attr("cx", function(d,i) {return dotScaleX(Math.round(roundHalf(eval("d." + rVar + "_growth"), stepper)*100)/100);})
