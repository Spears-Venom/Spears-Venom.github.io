...
function finalText() {
	...
	d3.select("#explanation")
		...
		.style("left", 50 + "px")
		.style("width", 550 + "px")
		.html("<p>Urbanization is a key process in ending extreme poverty and boosting shared prosperity. In the coming decades, urban areas will be where millions of Indians will have the chance to leave extreme poverty behind and thrive</p>" +
