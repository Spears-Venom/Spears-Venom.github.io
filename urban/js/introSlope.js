...
function introSlope() {
	...
	d3.select("#explanation")
		...
		.call(endall, function() {
				d3.select("#explanation")
					...
					.style("left", 600 + "px")
					.style("width", 350 + "px")
					.html("<p>We can take a closer look at the absolute changes of these cities</p> <p>Here we see the urban population in <span style='color: #858483;'>2001</span> on the left and in <span style='color: #DA6761;'>2011</span> on the right</p>");	
		})
		.transition().duration(1000)
		.style("opacity",1);
	...
	///////////////// Pearl River Delta //////////////////
	//////////////////////////////////////////////////////
	explanationText(varText = "Again it becomes apparent how fast Mumbai has grown during this decade", delay = delay, delayStep = 1.5);	
	...
	setTimeout(function() {oneCountrySlope("Bihar", delay)},(delay*3.25))
	explanationText(varText = "<p>Urban population density in Bihar jumped from 881 people per sq. km in <span style='color: #858483;'>2001</span> to 1106 in <span style='color: #DA6761;'>2011</span>, an increase of almost 26%!</p>" +
...
function oneCountrySlope(State, delay) {
	//Show one specific State
	cities2000.selectAll(".city_2000")
		.transition().duration(1000)
		.style("fill-opacity", function(d) {
			if (d.State != State) return 0;});
