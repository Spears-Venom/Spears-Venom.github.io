...
function introText() {
	...
	d3.select("#explanation")
		...
		.html("<p>Societies are shifting from having a rural nature to a more and more urban nature. We face the opportunity to set the course of urbanization on a more sustainable and equitable path</p>" +
			  "<p>This visualization is based on data on urbanization in India between <span style='color: #858483;'>2001</span> and <span style='color: #DA6761;'>2011</span> collected from Census of India and World Bank. It aims to provide you with a clear view on the magnitude of changes that can happen in only one decade and challenges you to think about the impact on the following years<p>")
		.transition().duration(1000)
		.style("opacity",1);
	...
	d3.select("#explanationIntro")
		...
		.style("left", 50 + "px")
		.style("width", 550 + "px")
		.html("Press Start to be taken through the complete story, or press the circles that correspond to <br><span style='color: #DA6761;'> map </span>| <span style='color: #3d5afe;'> slope </span> | <span style='color: #76ff03;'> histogram </span> | scatter <br> to jump straight to the intermediary views")	
		.style("opacity",1);
