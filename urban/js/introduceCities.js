...
function introduceCities() {
	...
	rScale
		.domain([d3.min(data, function(d) {return d.pop_2001;}),d3.max(data, function(d) {return d.pop_2011;})])
		.range([1,20]);
	...
	d3.select("#explanation")
		...
		.call(endall, function() {
				d3.select("#explanation")
					...
					.style("left", 400 + "px")
					.style("width", 400 + "px")
					.html("There are 4 city with a population between 800,000 to 1.1 million people");	
		})
		.transition().duration(1000)
		.style("opacity",1);
	...
	cities2010.selectAll(".city_2010")
		.filter(function(d) { return d.pop_2011 < 1.1e6;})
		.transition().duration(2000).delay(1000)
			.attr("r", function(d) {return rScale(d.pop_2011);})
			.style("fill-opacity", 1)
	...
	cities2000.selectAll(".city_2000")
		.filter(function(d) { return d.pop_2011 < 1.1e6;})
		.transition().duration(2000).delay(1000)
			.attr("r", function(d) {return rScale(d.pop_2001);})
			.style("fill-opacity", 1)
		.transition().duration(1500)
	...
	//////////////////////////////////////////////////////
	//Medium cities
	explanationText(varText = "47 cities with a population between 1.1 and 10 million people", delay = delay, delayStep = 1);	
		
	//Plot the sizes of the cities in 2010 in reddish
	cities2010.selectAll(".city_2010")
		.filter(function(d) { return d.pop_2011 >= 1.1e6 & d.pop_2011 < 10e6;})
	...
	//////////////////////////////////////////////////////
	//Large cities
	explanationText(varText = "And 3 megacities with more than 10 million people", delay = delay, delayStep = 2);	
		
	//Plot the sizes of the cities in 2010 in reddish
	cities2010.selectAll(".city_2010")
		.filter(function(d) { return d.pop_2011 >= 10e6;})
	...
	//////////////////////////////////////////////////////
	//Pearl River Delta
	explanationText(varText = "For example, Mumbai is India's largest urban area in population while Patna is largest in terms of land area", delay = delay, delayStep = 3);	
	...
	explanationText(varText = "Its population grew with more than 12% to almost 18.3 million people.Mellapuram in Kerala has the highest population growth of 897 %", delay = delay, delayStep = 4.25);	
