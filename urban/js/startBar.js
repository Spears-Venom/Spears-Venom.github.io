...
function startBar() {
	...
	var bardata = [{
		year: 2001,
		population: 122195109
	}, {
		year: 2011,
		population: 161464489
	...
	var total2000 = bardata[0].population;
	var total2010 = bardata[1].population;
	...
	d3.select("#explanation")
		...
		.call(endall, function() {
				d3.select("#explanation")
					...
					.style("left", 400 + "px")
					.style("width", 450 + "px")
					.html("Data is available on the 54 urban areas in the region with populations over 800,000 in 2011");	
		})
		.transition().duration(1000)
		.style("opacity",1);
	...
	explanationText(varText = "The 120 million people that were already living in the cities in <span style='color: #858483;'>2001</span> grew to 160 million in <span style='color: #DA6761;'>2011</span>", delay = delay, delayStep = 1);
	...
	//////////////////////////////////////////////////////
	//Growth
	explanationText(varText = "<p>That is an increase of 33.33 % in just 10 years , a difference of 40 million people</p> <p>This is an unprecedented increase in such a short time</p>", delay = delay, delayStep = 2);	
